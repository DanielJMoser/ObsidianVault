Die Connection ist ein **Objekt**, das von der [[_JDBC|JDBC]]-API bereitgestellt wird und es ermöglicht, eine **Verbindung** zu einer bestimmten Datenbank herzustellen.
